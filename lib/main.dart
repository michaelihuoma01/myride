...
import 'package:myride/bloc/state_bloc.dart';
import 'package:myride/bloc/state_provider.dart';
import 'package:myride/model/car.dart';

void main() => runApp(MyApp());

var currrentCar = carList.cars[0];
      ...
      children: <Widget>[
        RichText(
          text: TextSpan(
              ...
              children: [
                TextSpan(text: currrentCar.companyName),
                TextSpan(text: "\n"),
                TextSpan(
                    text: currrentCar.carName,
        ...
        RichText(
          text: TextSpan(style: TextStyle(fontSize: 16), children: [
            TextSpan(
                text: "£" + currrentCar.price.toString(),
...
class _CarCarouselState extends State<CarCarousel> {
  static final List<String> imgList = currrentCar.imgList;
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView.builder(
              ...
              itemCount: currrentCar.offerDetails.length,
              itemBuilder: (context, index) {
                return ListItem(
                  sheetItemHeight: sheetItemHeight,
                  mapVal: currrentCar.offerDetails[index],
                );
              },
            ),
          )
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView.builder(
              scrollDirection: Axis.horizontal,
              itemCount: currrentCar.specifications.length,
              itemBuilder: (context, index) {
                return ListItem(
                  sheetItemHeight: sheetItemHeight,
                  mapVal: currrentCar.specifications[index],
                );
              },
            ),
          )
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView.builder(
              scrollDirection: Axis.horizontal,
              itemCount: currrentCar.features.length,
              itemBuilder: (context, index) {
                return ListItem(
                  sheetItemHeight: sheetItemHeight,
                  mapVal: currrentCar.features[index],
                );
              },
            ),
          )
